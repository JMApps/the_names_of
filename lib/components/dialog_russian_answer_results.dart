...
class DialogRussianAnswerResults extends StatelessWidget {
  const DialogRussianAnswerResults({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var _databaseQuery = DatabaseQuery();
    var questionRussianController = QuestionRussianController();
    return Scaffold(
      appBar: AppBar(
